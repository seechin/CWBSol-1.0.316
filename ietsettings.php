<?php
    ...
    $closures = array( "HNC", "PLHNC", "MSA", "KGK", "KH", "PSE2", "PSE3", "PSE4", "PSE5", "PSE6", "PSE7", "PSE8", "PSE9", "PSE10", "PY", "HNCB", "D2", "Martynov-Sarkisov", "MSHNC", "BPGGHNC", "Marucho-Pettitt", "MHNC", "Modified-Verlet" );

    class IETSettings {
        public $workspace;
        public $np,$ntb,$rc,$nr,$box;
        public $log,$out,$verbo,$debug,$debugxc;
        public $closure,$steprism,$stephi,$temperature;
    ...
    function generate_calc_command($set, $rismhi3d){
        $exec = $rismhi3d;
        ...
        /*if (!empty($set->display) && $set->display != 0){
            $exec .= " display:mass".($set->display&1?",N,N0,volume":"").($set->display&2?",TS":"").($set->display&4?",lj":"").($set->display&8?",coul":"").($set->display&16?",Hef0":"");
    ...
    function generate_param_url($set){
        $url = "?";
        $plist = array("workspace", "solute", "solvent", "traj", "np", "ntb", "rc", "nr", "box", "log", "out", "verbo", "debug", "debugxc", "closure", "steprism", "stephi", "temperature", "save", "report", "display", "rdfbins", "rdfgrps", "fmt", "lsa", "xvvextend", "ndiis", "delvv", "errtol", "sd", "enlv", "coulomb", "coul_p", "ignoreram");
